...
object TestExcelFlatFileReader {
  ...
  val shouldNotExtractValues: IndexedSeq[IndexedSeq[String]] = Vector(
    Vector("text_value17", "formatted_value17", "TRUE", "8/23/12", "5:17:17 AM", "8/23/12 5:17", "17", "18.70", "35.70", "#DIV/0!", "sharedstrings_value")
  )
